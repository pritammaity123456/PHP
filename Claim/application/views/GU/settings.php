...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="form-row">
       <strong strong style="text-decoration: underline;"> Emp Name:</strong>&nbsp; <input type="hidden" id="name1" name="name1" value="<?php echo($aldta->emp_name);?>" required="true"> <p id="name"> <?php echo($aldta->emp_name);?></p>&nbsp;<button id="save" type="button" onclick="editName()" style="height: 30px;">Edit</button>
      </div>
  	</form>
      <?php
  		}
