...
<div class="modal-header">
      <h5 class="modal-title" id="exampleModalLabel">Claim Details: <?php echo $this->session->userdata('loggedin')->emp_name;?></h5>
  ...
  <div id="divPrint">
  	<div class="modal-body">
  	  <h2 class="center" style="text-align: center;">Synergic Softek Solutions Pvt. Ltd.</h2>
  	  <h3 class="center underline" style="text-align: center; text-decoration: underline;">Claim Voucher</h3>
   ...
   <tr>
     <td>Pay To</td>
     <td class="left_algn">:</td>
     <td class="left_algn"><?php foreach ($emp_dtls as $aldta) {
     	
     echo $aldta->emp_name;?></td>
     ...
     ?>
    	...
    	<div class="card">
      		<div class="card-body">
          			<table class="table table-bordered width" cellpadding="6">
            			<thead>
              				<tr class="t2">
				            ...
				            <tbody id="intro">
				              ...
				              ?>
				              <tr class="t2">
				              	<td style="text-align: center;"><?php echo $cldta->sl_no;?></td>
				                <td style="text-align: center;"><?php echo $cldta->claim_hd;?></td>
				                <td><textarea style="border: none; resize: none; overflow:hidden" rows="2" cols="35"><?php echo $cldta->remarks;?></textarea></td>
				                <td style="text-align: center;"><?php echo $cldta->amount;?></td>
				              </tr>
				              <?php
				                 endforeach;
				              ?>
				              <tr style="border: 0px solid black;">
				                <td ></td>
				                <td ></td>
				                <td class="right_algn" style="text-align:right;">Total</td>
				                <td class="border center" style="text-align: center;"><?php echo $claim->amount;?></td>
				              </tr>
				            </tbody>
          			</table>
          		</div>
    	...
    	<table  class="width noborder">
  			<?php foreach ($emp_dtls as $aldta):?>
  				<tr>
    				...
    				<td width="50%"></td>
    				<td width="50%"><?php echo $claim->approved_by;?></td>
  				</tr>
 	 		<?php endforeach;?>	
        	<tbody>
          		<tr>
