<div class="content-wrapper">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <?php if($alldata){
               foreach ($alldata as $aldta):
                ?>
                <tr>
                  <td><?php echo $aldta->head_cd;?></td>
                  <td><?php echo $aldta->head_desc;?></td>
    ...
    <script type="text/javascript">
      $('.edit-btn').click(function(){
        ...
        $.get( "<?php echo base_url().'index.php/admin/edit_claim_head_ajax'?>", { id: emp_id } )
          .done(function( data ) {
      ...
      $('.add-btn').click(function(){
        //var emp_id = $(this).attr('id');
        $.get( "<?php echo base_url().'index.php/admin/add_claim_head_ajax'?>")
          .done(function( data ) {
